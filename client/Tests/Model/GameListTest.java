...
class GameListTest
{
  ...
  {
    assertDoesNotThrow(
        () -> gameList.getGame(new Game("Cod2", "Infinity Ward", "PC", "M")));
  }
  ...
  @Test void addGame_O()
  {
    assertDoesNotThrow(() -> gameList.addGame(
        new Game("Cod the coddening", "Infinity Ward", "PC", "M")));
  }

  @Test void addGame_M()
  {
    gameList.addGame(
        new Game("Cod the coddening1", "Infinity Ward", "PC", "M"));
    gameList.addGame(
        new Game("Cod the coddening2", "Infinity Ward", "PC", "M"));
    gameList.addGame(
        new Game("Cod the coddening3", "Infinity Ward", "PC", "M"));
    gameList.addGame(
        new Game("Cod the coddening4", "Infinity Ward", "PC", "M"));
    gameList.addGame(
        new Game("Cod the coddening5", "Infinity Ward", "PC", "M"));
    gameList.addGame(
        new Game("Cod the coddening6", "Infinity Ward", "PC", "M"));
    assertDoesNotThrow(() -> gameList.addGame(
        new Game("Cod the coddening", "Infinity Ward", "PC", "M")));
  }
  ...
  {
    assertDoesNotThrow(() -> gameList.removeGame(
        new Game("Cod2", "Infinity Ward", "PC", "M")));
  }
  ...
  @Test void removeGame_M()
  {
    ...
    assertDoesNotThrow(() -> gameList.removeGame(
        new Game("Cod6", "PC", "Infinity Ward", "M")));
  }
