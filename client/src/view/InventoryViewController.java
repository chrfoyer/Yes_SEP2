...
public class InventoryViewController extends ViewController
{
  ...
  @FXML public TableColumn<SimpleGameViewModel, String> rentedColumn;
  @FXML public TableColumn<SimpleGameViewModel, String> consoleColumn;
  @FXML public TableColumn<SimpleGameViewModel, String> esrbColumn;
  @FXML public TableColumn<SimpleGameViewModel, String> producerColumn;
  ...
  @FXML public void addEdit(ActionEvent actionEvent)
  {
